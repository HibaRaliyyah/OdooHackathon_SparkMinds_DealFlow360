...
const ROLES: RoleOption[] = [
  {
    ...
    duties: 'Manages backend setup (products, price lists, discount tiers, warehouses) & platform analytics.',
  },
  {
    role: 'SALES_MANAGER',
    label: 'Sales Manager / Approver',
    officialTitle: 'Threshold Approvals & Deal Health',
    email: 'manager@dealflow360.demo',
    icon: Briefcase,
    color: 'text-purple-400',
    activeBg: 'bg-purple-600 text-white shadow-purple-500/30',
    duties: 'Reviews & approves/rejects threshold-exceeding quotes, configures tiers, monitors deal health.',
  },
  {
    role: 'SALES_REP',
    label: 'Sales Rep',
    ...
    duties: 'Builds quotations, applies discounts, adds upsell items, tracks approvals & fulfillment.',
  },
  {
    role: 'FINANCE',
    label: 'Finance / Operations User',
    officialTitle: '2nd Level Approvals & Fulfillment Splits',
    email: 'finance@dealflow360.demo',
    icon: Calculator,
    color: 'text-emerald-400',
    activeBg: 'bg-emerald-600 text-white shadow-emerald-500/30',
    duties: '2nd level approvals for high risk discounts, manages fulfillment splits & billing reconciliation.',
  },
  {
    role: 'CUSTOMER',
    ...
    duties: 'Views quotation online, requests line-level changes/discount counters, confirms final terms.',
  },
];
